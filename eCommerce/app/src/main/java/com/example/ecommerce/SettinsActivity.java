...
public class SettinsActivity extends AppCompatActivity {
    ...
    private TextView profileChangeTxtBtn, closeTextBtn, saveTextButton;
    ...
    private void updateOnlyUserInfo() {
        ...
        Toast.makeText(SettinsActivity.this, "Profile updated successfully ", Toast.LENGTH_SHORT).show();
        finish();
    ...
    private void uploadImage() {
        ...
        progressDialog.setMessage("Please wait while we updating your account");
